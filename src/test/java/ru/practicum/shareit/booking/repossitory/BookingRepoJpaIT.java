...
class BookingRepoJpaIT {
    ...
    void findAllByBookerAndStartIsAfterOrderByStartDescTest() {
        ...
        List<Booking> bookingList = bookingRepoJpa.findAllByBookerAndStartIsAfterOrderByStartDesc(booker, LocalDateTime.now(), null);
    ...
    void findAllByOwnerAndStartIsAfterOrderByStartDescTest() {
        List<Booking> bookingList = bookingRepoJpa.findAllByOwnerAndStartIsAfterOrderByStartDesc(booker2.getId(), LocalDateTime.now(), null);
    ...
    void findAllBookingsForBookerWithStartAndEndTest() {
        ...
        List<Booking> bookingList = bookingRepoJpa.findAllBookingsForBookerWithStartAndEnd(
                booker1, localDateTime, localDateTime, null);
    ...
    void findAllByBookerAndStatusEqualsOrderByStartDescTest() {
        ...
        List<Booking> bookingList = bookingRepoJpa
                .findAllByBookerAndStatusEqualsOrderByStartDesc(booker1, Status.APPROVED, null);
    ...
    void findAllByOwnerAndStatusEqualsOrderByStartDescTest() {
        ...
        List<Booking> bookingList = bookingRepoJpa.findAllByOwnerAndStatusEqualsOrderByStartDesc(booker2.getId(), Status.WAITING, null);
    ...
    void findAllBookingsForOwnerWithStartAndEndTest() {
        User owener = booker2;
        LocalDateTime localDateTime = LocalDateTime.now();
        List<Booking> bookingList = bookingRepoJpa.findAllBookingsForOwnerWithStartAndEnd(owener, localDateTime, localDateTime, null);
    ...
    void findAllByOwnerAndEndIsBeforeOrderByStartDescTest() {
        User owener = booker2;
        LocalDateTime localDateTime = LocalDateTime.now();
        List<Booking> bookingList = bookingRepoJpa.findAllByOwnerAndEndIsBeforeOrderByStartDesc(owener, localDateTime, null);
    ...
    void findAllByBookerAndEndIsBeforeOrderByStartDescTest() {
        ...
        List<Booking> bookingList = bookingRepoJpa
                .findAllByBookerAndEndIsBeforeOrderByStartDesc(booker1, LocalDateTime.now(), null);
